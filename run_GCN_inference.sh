...
python GCN_inference.py \
  -fd ./result_latent_CV/Contrastive_Supervised_Adversarial_ae_CV/[All_latent]_244_d750_adv0.05_con0.2/latent_inference.csv \
  -ad ./result/latent_snf_K15/244_d750/SNF_fused_inference.csv \
  -sl ./data/inference_sample.csv \
